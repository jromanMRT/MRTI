...
| Transversal. CONTPAQi multisitio | Completa | 2026-08-24 | RH `1527edf`, vinculación integral `b113377`. Las migraciones idempotentes `007_contpaq_multi_source.sql` y `008_employee_contpaq_links.sql` se aplicaron dos veces; descubre automáticamente bases con la estructura de Nóminas y conserva `MRT` como clave compatible. Carga publicada: 4 sitios, 5,004 relaciones/1,963 personas únicas/311 activas vigentes; 13,461 eventos, 536,054 periodos, 67,166 recibos y 1,894 finiquitos, sin errores. Los 5,004 expedientes del espejo tienen vínculo explícito con la ficha central; la conciliación posterior a cada sincronización alimenta dashboard, directorio, vacaciones y selectores. Frontend agrupado/filtrado por sitio, perfiles multirrelación y actualización manual; empleados cada 2 h e historial diario. Pruebas 17/17, build, `git diff --check`, health 200, `/rh/` 200, ruta protegida sin token 401, PM2 online y sin errores nuevos; segunda conciliación `updated: 0` confirmó idempotencia. Rollback: detener RH, revertir `b113377` y `1527edf`, reconstruir/reiniciar; las tablas aditivas pueden permanecer y CONTPAQi no se modifica. |
