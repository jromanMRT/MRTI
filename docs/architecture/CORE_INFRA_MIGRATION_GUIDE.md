...
| Transversal. CONTPAQi multisitio | Completa | 2026-08-24 | RH `1527edf`, vinculación integral `b113377`, Diseño organizacional `1f67215`. Las migraciones idempotentes `007_contpaq_multi_source.sql`, `008_employee_contpaq_links.sql` y `009_contpaq_org_design.sql` se aplicaron dos veces; descubre automáticamente bases con la estructura de Nóminas y conserva `MRT` como clave compatible. Carga publicada: 4 sitios, 5,004 relaciones/1,963 personas únicas/311 activas vigentes; 13,461 eventos, 536,054 periodos, 67,166 recibos y 1,894 finiquitos, sin errores. Los 5,004 expedientes del espejo tienen vínculo explícito con la ficha central; la conciliación posterior a cada sincronización alimenta dashboard, directorio, vacaciones, selectores y Diseño organizacional. La estructura vigente contiene 311 puestos ocupados y 38 unidades: MAT Metals 4/2 departamentos, MRT 54/7 y MineWorks 253/26; conserva los 54 puestos y 41 relaciones manuales previas, sin activos sin puesto ni bajas con asignación vigente. Frontend agrupado/filtrado por sitio, perfiles multirrelación y actualización manual; empleados y diseño cada 2 h e historial diario. Pruebas 19/19, build, `git diff --check`, health 200, `/rh/` 200, ruta protegida sin token 401, PM2 online y sin errores nuevos; segunda conciliación organizacional creó 0 y actualizó 0. Rollback: detener RH, revertir `1f67215`, `b113377` y `1527edf`, cerrar/desactivar sólo las asignaciones y puestos registrados en `contpaq_position_links`, desactivar unidades cuya descripción indique origen sincronizado y las raíces de `contpaq_site_org_units`, reconstruir/reiniciar; las tablas aditivas pueden permanecer y CONTPAQi no se modifica. |
